...
export const pmcmcInsiderDetection: Project = {
  ...
  results: [
    ...
    'The project shows that particle MCMC methods can scale Bayesian inference for informed-trading detection to tens of thousands of trades in decentralized prediction markets.'
  ],
  metrics: [
    {
      label: 'Detection AUC',
  ...
  retrospective: {
    ...
    nowDifferent: [
      ...
      'The revisit runs on my current workflow: Claude Code orchestrating subagents against a benchmark script that gates every change on a synthetic-injection check (ROC AUC at or above 0.85 with planted insiders ranked on top) before it lands.'
    ]
  },
  timeline: [
    {
